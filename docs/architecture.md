...
- Cooperative cancellation via `AbortSignal` (ADR 0009) including nested `asAgentTool` (ADR 0010)
- Local parent/child run causality via optional `parentRunId` (ADR 0011)
