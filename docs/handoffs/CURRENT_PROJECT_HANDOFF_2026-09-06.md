...
**Owner (private notes repo)**

- https://github.com/eloguidici/agentstride-notes — growth, career/LinkedIn, launch checklist

**Launch (this repo)**

- `docs/research/public-package-dry-run.md`
- `docs/narrative/LAUNCH_CHECKLIST.md`
- `docs/engineering/PUBLIC_NPM_READINESS_AUDIT.md`
